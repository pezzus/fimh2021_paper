...
\begin{figure}[tb]
    \centering
    \begin{tikzpicture}
    \node (A) {\includegraphics[width=0.3\textwidth]{activ.png}};
    \node[anchor=west] (B) at ($(A.east)+(1cm,0)$) {\includegraphics[width=0.2\textwidth]{Zm_Ii.png}};
    \node[anchor=west] (C) at (B.east) {\includegraphics[width=0.2\textwidth]{Zm_V1.png}};
    % labels
    ...
    % colorbars
    \node[anchor=north] (Al) at (A.south) {\includegraphics[width=0.22\textwidth]{cbar1.png}};
    \node[anchor=north] at (B.south) {\includegraphics[width=0.15\textwidth]{cbar2.png}};
    \node[anchor=north] at (C.south) {\includegraphics[width=0.12\textwidth]{cbar3.png}};
    \end{tikzpicture}
...
\begin{figure}[tb]
    \centering
    \begin{tikzpicture}
    \node[inner sep=0pt,outer sep=0pt] (a) {\includegraphics[width=0.22\textwidth]{ue_t20.png}}
    node[anchor=south] at (a.north) {$t = \SI{20}{\ms}$};
    \end{tikzpicture}%
    %%%%
    \begin{tikzpicture}
    \node[inner sep=0pt,outer sep=0pt] (a) {\includegraphics[width=0.22\textwidth]{ue_t50.png}}
    node[anchor=south] at (a.north) {$t = \SI{50}{\ms}$};
    \end{tikzpicture}%
    %%%%
    \begin{tikzpicture}
    \node[inner sep=0pt,outer sep=0pt] (a) {\includegraphics[width=0.22\textwidth]{ue_t90.png}}
    node[anchor=south] at (a.north) {$t = \SI{90}{\ms}$};
    \end{tikzpicture}%
    %%%%
    \begin{tikzpicture}
    \node[inner sep=0pt,outer sep=0pt] (a) {\includegraphics[width=0.22\textwidth]{ue_t110.png}}
